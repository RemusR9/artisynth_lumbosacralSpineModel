 ...
 * 
 *
 * Modified and finalized for pre-tension by Robin Remus (May 2020)
 */
 
public class MyUWLigamentMaterial extends AxialMaterial {
   ...
   protected static double DEFAULT_TOTAL_FORCE = 0.0;
   ...
   protected double forceTotal = DEFAULT_TOTAL_FORCE;
   
   public static PropertyList myProps =
      new PropertyList (MyUWLigamentMaterial.class, AxialMaterial.class);
   ...
   @Override
   public double computeDFdl (double l, double ldot, double l0, 
		   double excitation) {
      double strain = ( l - l0 ) / l0;
      double strain_dl = (1 + referenceStrain) / l0; 
      // Ligament is inactive if l <= slackLength
      if (l <= l0) {   
          return 0;
       }
